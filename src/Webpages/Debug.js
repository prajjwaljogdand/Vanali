        ...
        <header>
          ...
          <Box paddingLeft={"15%"}>
            {this.state.data.temp_data ? (
              <>
                {" "}
                <Typography textAlign={'center'} width={900}>
                  Ambient Temperature {this.state.data.temp_data.ambient_temp}
                </Typography>
                <AreaChart width={900} height={200} data={this.state.ambientTemp}>
                  <defs>
                ...
                <Typography textAlign={'center'} width={900}> Env Temperature {this.state.data.temp_data.env_temp}</Typography>
                <AreaChart width={900} height={200} data={this.state.envTemp}>
                  <defs>
                    <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#33ff33" stopOpacity={0.8} />
                      <stop offset="95%" stopColor="#33ff33" stopOpacity={0} />
                ...
                <AreaChart width={900} height={200} data={this.state.engineTemp}>
                  <defs>
                    <linearGradient id="colorValue" x1="0" y1="0" x2="0" y2="1">
                      <stop offset="5%" stopColor="#33ff33" stopOpacity={0.8} />
                      <stop offset="95%" stopColor="#33ff33" stopOpacity={0} />
          ...
          <Box paddingLeft={"15%"}>
            {this.state.data.pressure_data ? (
              <>
                {" "}
                <Typography>
                  Front Tyre Right Pressure{" "}
                  {this.state.data.pressure_data.front_tyre_right}
                </Typography>
                <Typography>
                  Front Tyre Left Pressure{" "}
                  {this.state.data.pressure_data.front_tyre_left}
                </Typography>
                <Typography>
                  Back Tyre Right Pressure{" "}
                  {this.state.data.pressure_data.back_tyre_right}
                </Typography>
                <Typography>
                  Back Tyre Left Pressure{" "}
                  {this.state.data.pressure_data.back_tyre_left}
                </Typography>
              </>
            ) : (
              <CircularProgress />

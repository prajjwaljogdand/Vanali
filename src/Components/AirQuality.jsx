...
const AirQuality = (props)=>{
  return(
    ...
    <Paper elevation={1} >
    <Typography variant="h6" component="h6" sx={{paddingLeft: '15px'}} ><AirIcon sx={{  fontSize: '2rem', color : '#00A3FF', position : 'relative', top : '0.5rem' }}/> {props.airQuality}aiq</Typography>
